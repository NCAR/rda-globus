...
def parse_input():
	...
	parser.add_argument('-ap', action="store_true", default=False, help="Add endpoint permission")
	parser.add_argument('-rp', action="store_true", default=False, help="Delete endpoint permission")
	parser.add_argument('-ri', action="store", dest="ri", type=int, help="dsrqst request index")
	parser.add_argument('-ds', action="store", dest="ds", help="Dataset ID, specified as dsnnn.n or nnn.n.  Required with the -em argument.")
	parser.add_argument('-em', action="store", dest="em", help="User e-mail.  Required with the -ds argument.")
